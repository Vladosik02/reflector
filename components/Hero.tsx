...
export default function Hero() {
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      <div
        className="orb pointer-events-none absolute -left-24 top-10 h-48 w-48 rounded-full bg-orb-violet animate-subtle-pulse md:-left-32 md:h-72 md:w-72"
        aria-hidden="true"
      />
      <div
      ...
      <div className="vignette-bottom pointer-events-none absolute inset-x-0 bottom-0 h-32" aria-hidden="true" />
      ...
      <div className="relative mx-auto max-w-site px-6 pb-20 pt-24 md:pb-28 md:pt-32">
        ...
        <div className="mt-10 flex flex-wrap items-center gap-3">
          <a
            href="#upload"
            className="group relative rounded-btn bg-ink-cta px-5 py-3 text-sm font-medium text-white shadow-cta transition-all hover:shadow-cta-hover hover:-translate-y-0.5"
          >
            <span
              aria-hidden="true"
